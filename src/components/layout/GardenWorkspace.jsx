...
const NAV_ITEMS = [
  ['health', 'favorite', 'Health'], ['automations', 'bolt', 'Automations'], ['dashboard', 'home', 'Dashboard'], ['compass', 'explore', 'Daily Compass'], ['tasks', 'checklist', 'Tasks'], ['plans', 'alt_route', 'If–Then Plans'],
